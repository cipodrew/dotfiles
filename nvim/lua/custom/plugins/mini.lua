return {
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --  - vab  - [V]isually select [A]round [) or }]paren
      ...
      -- following remap NOT NEEDED, mini only fires if you give the other motions QUICKLY and you keep s standard functionality after a split second
      ...
      -- Set keymap to open mini.files
      vim.keymap.set('n', '<leader>-', function() require('mini.files').open() end, { desc = 'Open mini.files file explorer' })
    end,
